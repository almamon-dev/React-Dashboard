...
export default function Index({ permissions, filters = {}, auth }) {
    ...
    const confirmDelete = () => {
        router.delete(route('admin.permissions.destroy', deleteState.id), {
        ...
        <AdminLayout>
            ...
            <div className="space-y-6 max-w-[1240px] mx-auto pb-20">
                                        ...
                                        >
                                            ...
                                            <td className="pr-7 py-5 text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    ...
                                                    {auth.user.permissions.includes('permissions.delete') && (
                                                        <button 
                ...
                <DeleteModal
                    ...
                    title="Delete Permission"
                    message="Are you sure you want to delete this permission? This may affect user access."
                />
            </div>
        </AdminLayout>
    );
